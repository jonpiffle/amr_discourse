...
partition\_length                          & Number of groups in the partition               \\
partition\_length\_squared                 & Number of groups in the partition squared       \\
mean/min/max/std\_dev partition\_facts     & Number of facts per partition                   \\
mean/min/max/std\_dev subgraph\_similarity & Pairwise subgraph similarity between all groups \\
mean/min/max/std\_dev verb\_similarity     & Pairwise verb similarity between all groups     \\ \bottomrule
\end{tabular}
\end{table}
